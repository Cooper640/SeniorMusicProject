...
public class AnalizerTrigram{
	...
	static File libraryPercentStorage = new File("Songs/_Current Library Analysis/Trigram/Bach vs Byrd.txt");
	...
	static String ARTIST4 = "Chopin";
	static String ARTIST3 = "Mozart";
	static String ARTIST2 = "Byrd";
